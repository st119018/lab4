...
void drawEdges(unsigned char* buffer, std::vector <Vertex>& vertices, const  std::vector <std::pair <std::size_t, std::size_t>>& edges, int width, int height, int stride, const int ADDPIXELS, int bufferSize);
